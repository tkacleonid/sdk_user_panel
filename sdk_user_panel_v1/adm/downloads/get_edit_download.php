...
?>
	<table style="width:100%;">
		<tr>
			<td colspan=2>
				<p id="error_edit_download_dialog" style="color:red;"></p>
			</td>
		</tr>
		<tr style='display:none;'>
			...
			<td style="border:1px solid #5a1f08;padding:5px;text-align:center;">
				<input value='<?php echo $id_group_download;  ?>' id="id_group_downloads_edit_download_dialog" type="textbox" style="width:90%;">
			</td>
		</tr>
		<tr>
			...
			<td style="border:1px solid #5a1f08;padding:5px;text-align:center;">
				<input value='<?php echo $name_download;  ?>' id="name_edit_download_dialog" type="textbox" style="width:90%;">
			</td>
		</tr>
		<tr>
			<td style="border:1px solid #5a1f08;padding:5px;background:#f8baa1;width:250px;font-weight:bold;">
			...
			<td style="border:1px solid #5a1f08;padding:5px;text-align:center;">
				<input <?php echo $status_download;  ?> id="visibility_edit_download_dialog" type="checkbox" style="" >
			</td>
		</tr>
		<tr>
			<td style="border:1px solid #5a1f08;padding:5px;background:#f8baa1;width:250px;font-weight:bold;">
			...
			<td style="border:1px solid #5a1f08;padding:5px;text-align:center;">
				<textarea id="short_description_edit_download_dialog" style="width:90%;height:150px;overflow:auto;"><?php echo $short_description_download;  ?></textarea>
			</td>
		</tr>
		<tr>
			<td style="border:1px solid #5a1f08;padding:5px;background:#f8baa1;width:250px;font-weight:bold;">
			...
			<td style="border:1px solid #5a1f08;padding:5px;text-align:center;">
				<textarea id="long_description_edit_download_dialog" style="width:90%;height:300px;overflow:auto;"><?php echo $long_description_download;  ?></textarea>
			</td>
		</tr>
		<tr>
			<td style="border:1px solid #5a1f08;padding:5px;background:#f8baa1;width:300px;font-weight:bold;">
			...
			<td style="border:1px solid #5a1f08;padding:5px;text-align:center;">
				<div style="height:25px;">
					<div id="ref_icon_preview_edit_download_dialog" style="width:25px; height:100%;padding:0px;margin:0px;float:left;display:inline;background:#f0efee url('../../styles/images/preview_icon.png') center no-repeat;border:1px solid black;border-right:none;cursor:pointer;">
					</div>
					<div style="padding:0px;margin:0px;float:left;height:100%;">
						<input value='<?php echo $icon_download;  ?>' id="path_icon_edit_download_dialog" type="textbox" style="width: 400px;height:100%;padding:0px;background: #f0efee;border:none;border:1px solid black;padding:0px;margin:0px;" disabled>
					</div>
					<div style="float:left;height:100%;padding:0px">
						<button onclick='fn_btn_choice_icon_edit_download_dialog();' class="btn" id="btn_choice_icon_edit_download_dialog" style="height:100%;padding:0px;vertical-align:middle;margin:0px;font-size:0.6em;">Выбрать</button>
					</div>
		...
		<tr>
			...
			<td style="border:1px solid #5a1f08;padding:5px;text-align:center;">
				<div style="height:25px;">
					<div onclick="fn_file_preview($('#path_file_edit_download_dialog').val());" id="ref_file_preview_edit_download_dialog" style="width:25px; height:100%;padding:0px;margin:0px;float:left;display:inline;background:#f0efee url('../../styles/images/preview_icon.png') center no-repeat;border:1px solid black;border-right:none;cursor:pointer;">
					</div>
					<div style="padding:0px;margin:0px;float:left;height:100%;">
						<input value='<?php echo $ref_download;  ?>' id="path_file_edit_download_dialog" type="textbox" style="width: 400px;height:100%;padding:0px;background: #f0efee;border:none;border:1px solid black;padding:0px;margin:0px;" disabled>
					</div>
					<div style="float:left;height:100%;padding:0px">
						<button onclick='fn_btn_choice_file_edit_download_dialog();' class="btn" id="btn_choice_file_edit_download_dialog" style="height:100%;padding:0px;vertical-align:middle;margin:0px;font-size:0.6em;">Выбрать</button>
					</div>
					<div style="float:left;">
					</div>
				</div>			
		...
		<tr>
			...
			<td style="border:1px solid #5a1f08;padding:5px;text-align:center;">
				<textarea id="comment_edit_download_dialog" style="width:90%;height:150px;overflow:auto;"><?php echo $comment_download;  ?></textarea>
			</td>
		</tr>
		<tr>
			<td style="padding-top:10px;text-align:center;" colspan=2>
				<button id="btn_save_edit_download_dialog" class="btn" onclick="fn_save_edit_download(<?php echo $id_download; ?>);">Сохранить</button>
			</td>
		</tr>
	</table>
	<input type="hidden" id="hdn_id_download" value="<?php echo $id_download; ?>">
<script type="text/javascript">
function fn_tinymce_for_edit_download()
{	
	tinymce.init({
		selector: "#long_description_edit_download_dialog",
		theme: "modern",
...
$(function(){
	...
	$("#btn_save_edit_download_dialog").button();
	$("#btn_choice_file_edit_download_dialog").button();
	$("#btn_choice_icon_edit_download_dialog").button();
	
	$("#ref_icon_preview_edit_download_dialog").mouseover("on",function(e){
		this.t = this.title;
		this.title = '';	
		...
		img.onload = function(){
			...
			$("#image_preview").append("<img style='width:"+n_w+"px;height:"+n_h+"px;' src="+($('#path_icon_edit_download_dialog').val())+ " alt='Отсутствует изображение' />");
		}
		img.src = $('#path_icon_edit_download_dialog').val();	
	...
	$('#ref_icon_preview_edit_download_dialog').mouseout("on",function(){
		this.title = this.t;	
		$("#image_preview").remove();
	});	
	$("#ref_icon_preview_edit_download_dialog").mousemove(function(e){
		$("#image_preview")
			.css("top",(e.pageY - xOffset) + "px")
			.css("left",(e.pageX + yOffset) + "px");
	});	
