<?php
	...
	$query = "select position,id from $tbl_group_downloads where position < $cur_pos order by position DESC";
	...
	$query = "update $tbl_group_downloads set position=$pos_prev where id=$id;";
	...
	$query = "update $tbl_group_downloads set position=$cur_pos where id=$id_prev;";
