<?php
	...
	$query = "select position,id from $tbl_sign_algorithms where position > $cur_pos  and key_type_board='$key_type_board' order by position ASC";
	...
	$query = "update $tbl_sign_algorithms set position=$pos_next where id=$id  and key_type_board='$key_type_board';";
	...
	$query = "update $tbl_sign_algorithms set position=$cur_pos where id=$id_next  and key_type_board='$key_type_board';";
