<?php
	...
	$query = "select position,id from $tbl_sdk_express_algorithms where position > $cur_pos AND  key_type_board='$key_type_board' order by position  ASC";
	...
	$query = "update $tbl_sdk_express_algorithms set position=$pos_next where id=$id AND  key_type_board='$key_type_board';";
	...
	$query = "update $tbl_sdk_express_algorithms set position=$cur_pos where id=$id_next AND  key_type_board='$key_type_board';";
