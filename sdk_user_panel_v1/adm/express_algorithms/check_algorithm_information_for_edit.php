<?php
	...
	$query= "select count(*) from $tbl_sdk_express_algorithms where key_algorithm='$key_algorithm' and id<>$id_algorithm";
	...
	$query= "select count(*) from $tbl_sdk_express_algorithms where name_algorithm='$name_algorithm' and id<>$id_algorithm";
