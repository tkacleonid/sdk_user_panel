...
?>
	<table style='width:100%;'>
		<tr>
			<td colspan=2>
				<p id="error_edit_sign_algorithms_dialog" style="color:red;"></p>
			</td>
		</tr>
		<tr style='display:none;'>
			...
			<td style="border:1px solid #5a1f08;padding:5px;">
				<input value='<?php echo $id_type_board; ?>' id='id_type_board_edit_sign_algorithms_dialog' type='textbox' style='width:90%;' >
			</td>
		</tr>
		<tr>
			...
			<td style="border:1px solid #5a1f08;padding:5px;">
				<input value='<?php echo $name_sign_algorithm; ?>' id='name_edit_sign_algorithms_dialog' type='textbox' style='width:90%;' >
			</td>
		</tr>
		<tr>
			<td style="border:1px solid #5a1f08;padding:5px;background:#f8baa1;width:300px;font-weight:bold;">
			...
			<td style="border:1px solid #5a1f08;">
				<textarea id='description_edit_sign_algorithms_dialog' style='width:90%;height:200px;' ><?php echo $description_sign_algorithm; ?></textarea>
			</td>
		</tr>
		<tr>
			<td style="border:1px solid #5a1f08;padding:5px;background:#f8baa1;width:300px;font-weight:bold;">
			...
			<td style="border:1px solid #5a1f08;padding:5px;text-align:center;">
				<div style="height:25px;">
					<div onclick="fn_file_preview($('#path_html_edit_sign_algorithms_dialog').val());" id="ref_html_preview_edit_sign_algorithms_dialog" style="width:25px; height:100%;padding:0px;margin:0px;float:left;display:inline;background:#f0efee url('../../styles/images/preview_icon.png') center no-repeat;border:1px solid black;border-right:none;cursor:pointer;">
					</div>
					<div style="padding:0px;margin:0px;float:left;height:100%;">
						<input value='<?php echo $ref_web_page_text_sign_algorithm; ?>' id="path_html_edit_sign_algorithms_dialog" type="textbox" style="width: 400px;height:100%;padding:0px;background: #f0efee;border:none;border:1px solid black;padding:0px;margin:0px;" disabled>
					</div>
					<div style="float:left;height:100%;padding:0px">
						<button onclick='fn_btn_choice_file_html_edit_sign_algorithms_dialog();' class="btn" id="btn_choice_html_edit_sign_algorithms_dialog" style="height:100%;padding:0px;vertical-align:middle;margin:0px;font-size:0.6em;">Выбрать</button>
					</div>
		...
		<tr>
			...
			<td style="border:1px solid #5a1f08;padding:5px;text-align:center;">
				<div style="height:25px;">
					<div onclick="fn_file_preview($('#path_pdf_edit_sign_algorithms_dialog').val());" id="ref_pdf_pdf_preview_edit_sign_algorithms_dialog" style="width:25px; height:100%;padding:0px;margin:0px;float:left;display:inline;background:#f0efee url('../../styles/images/preview_icon.png') center no-repeat;border:1px solid black;border-right:none;cursor:pointer;">
					</div>
					<div style="padding:0px;margin:0px;float:left;height:100%;">
						<input value='<?php echo $ref_pdf_text_sign_algorithm; ?>' id="path_pdf_edit_sign_algorithms_dialog" type="textbox" style="width: 400px;height:100%;padding:0px;background: #f0efee;border:none;border:1px solid black;padding:0px;margin:0px;" disabled>
					</div>
					<div style="float:left;height:100%;padding:0px">
						<button onclick='fn_btn_choice_file_pdf_edit_sign_algorithms_dialog();' class="btn" id="btn_choice_pdf_edit_sign_algorithms_dialog" style="height:100%;padding:0px;vertical-align:middle;margin:0px;font-size:0.6em;">Выбрать</button>
					</div>
					<div style="float:left;">
					</div>
				</div>			
		...
		<tr>
			...
			<td style="border:1px solid #5a1f08;padding:5px;">
				<input <?php echo $status_show_pdf_text_sign_algorithm; ?> id='visibility_ref_pdf_edit_sign_algorithms_dialog' type='checkbox' style='width:90%;' >
			</td>
		</tr>
		<tr>
			<td style="border:1px solid #5a1f08;padding:5px;background:#f8baa1;width:300px;font-weight:bold;">
			...
			<td style="border:1px solid #5a1f08;">
				<textarea id='comment_edit_sign_algorithms_dialog' style='width:90%;height:200px;' ><?php echo $comment_sign_algorithm; ?></textarea>
			</td>
		</tr>
		<tr>
			<td style="border:1px solid #5a1f08;padding:5px;background:#f8baa1;width:300px;font-weight:bold;">
			...
			<td style="border:1px solid #5a1f08;">
				<textarea id="text_edit_sign_algorithms_dialog" style="width:90%;height:300px;overflow:auto;"><?php echo $text_sign_algorithm; ?></textarea>
			</td>
		</tr>
		<tr>
			<td style="border:1px solid #5a1f08;padding:5px;background:#f8baa1;width:300px;font-weight:bold;">
			...
			<td style="border:1px solid #5a1f08;padding:5px;">
				<input <?php echo $status_use_web_page_text_sign_algorithm; ?>  id='use_ref_html_edit_sign_algorithms_dialog' type='checkbox' style='width:90%;' >
			</td>
		</tr>
		<tr>
			<td style="border:1px solid #5a1f08;padding:5px;background:#f8baa1;width:300px;font-weight:bold;">
			...
			<td style="border:1px solid #5a1f08;padding:5px;">
				<input <?php echo $status_sign_algorithm; ?> id='visibility_edit_sign_algorithms_dialog' type='checkbox' style='width:90%;' >
			</td>
		</tr>
		<tr>
			<td colspan=2 style='font-size:1em;text-align:center; padding-top:20px;'>
				<button class='btn' onclick="fn_edit_sign_algorithms_preview();">Предварительный просмотр</button>
				<button onclick="fn_save_edit_sign_algorithms(<?php echo $id_sign_algorithm; ?>);" class='btn' id='btn_edit_sign_algorithms_dialog'>Сохранить модуль</button>
			</td>
		</tr>
	</table>
	<input type='hidden' id='id_sign_algorithm_dialog_edit_sign_algorithm' value="<?php echo $id_sign_algorithm; ?>"/>
	<script type="text/javascript">
		$(function(){
			$(".btn").button();
			fn_tinymce_for_edit_sign_algorithm();
		});
	</script>