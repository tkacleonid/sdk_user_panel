<?php
	...
	$dispaly_none_choice_rle= "";
	if(!empty($_POST['choice_ref_algorithm_for_rle']))
	{
		$dispaly_none_choice_rle= "style='display:none;'";
	}
...
?>
	<table style='width:100%;'>
		...
		<tr>
			...
			<td style="border:1px solid #5a1f08;padding:5px;">
				<?php echo $name_algorithm_algorithm;?>
			</td>
		</tr>
		<tr>
			<td style="border:1px solid #5a1f08;padding:5px;background:#f8baa1;width:300px;font-weight:bold;">
			...
			<td style="border:1px solid #5a1f08;padding:5px;text-align:center;">
				<div style="height:25px;">
					<div onclick="fn_html_algorithm_preview($('#path_html_algorithm_dialog_show_information_express_algorithm').val());" id="ref_html_algorithm_preview_dialog_show_information_express_algorithm" style="width:25px; height:100%;padding:0px;margin:0px;float:left;display:inline;background:#f0efee url('../../styles/images/preview_icon.png') center no-repeat;border:1px solid black;border-right:none;cursor:pointer;">
					</div>
					<div style="padding:0px;margin:0px;float:left;height:100%;">
						<input value='<?php echo $ref_web_page_text_algorithm_algorithm;?>' id="path_html_algorithm_dialog_show_information_express_algorithm" type="textbox" style="width: 400px;height:100%;padding:0px;background: #f0efee;border:none;border:1px solid black;padding:0px;margin:0px;" disabled>
					</div>
		...
		<tr>
			...
			<td style="border:1px solid #5a1f08;padding:5px;text-align:center;">
				<div style="height:25px;">
					<div onclick="fn_html_algorithm_preview($('#path_pdf_algorithm_dialog_show_information_express_algorithm').val());" id="ref_pdf_algorithm_preview_dialog_show_information_express_algorithm" style="width:25px; height:100%;padding:0px;margin:0px;float:left;display:inline;background:#f0efee url('../../styles/images/preview_icon.png') center no-repeat;border:1px solid black;border-right:none;cursor:pointer;">
					</div>
					<div style="padding:0px;margin:0px;float:left;height:100%;">
						<input value='<?php echo $ref_pdf_text_algorithm_algorithm; ?>' id="path_pdf_algorithm_dialog_show_information_express_algorithm" type="textbox" style="width: 400px;height:100%;padding:0px;background: #f0efee;border:none;border:1px solid black;padding:0px;margin:0px;" disabled>
					</div>
					<div style="float:left;">
					</div>
				</div>			
		...
		<tr>
			...
			<td style="border:1px solid #5a1f08;padding:5px;">
				<input <?php echo $status_show_pdf_algorithm; ?> id='visibility_ref_pdf_algorithm_dialog_show_information_express_algorithm' type='checkbox' style='width:90%;' disabled >
			</td>
		</tr>
		<tr <?php echo $dispaly_none_choice_rle; ?> >
			<td style="border:1px solid #5a1f08;padding:5px;background:#f8baa1;width:300px;font-weight:bold;">
				Ссылка на РЛЭ:
			</td>
			<td style="border:1px solid #5a1f08;padding:5px;text-align:center;">
				<div style="height:25px;">
					<div onclick="fn_ref_rle_algorithm_preview($('#path_id_rle_algorithm_dialog_show_information_express_algorithm').val());" id="ref_rle_algorithm_preview_dialog_show_information_express_algorithm" style="width:25px; height:100%;padding:0px;margin:0px;float:left;display:inline;background:#f0efee url('../../styles/images/preview_icon.png') center no-repeat;border:1px solid black;border-right:none;cursor:pointer;">
					</div>
					<div style="padding:0px;margin:0px;float:left;height:100%;">
						<input value='<?php echo $key_rle_algorithm; ?>' id="path_rle_algorithm_dialog_show_information_express_algorithm" type="textbox" style="width: 400px;height:100%;padding:0px;background: #f0efee;border:none;border:1px solid black;padding:0px;margin:0px;" disabled>
						<input id="path_id_rle_algorithm_dialog_show_information_express_algorithm" value='<?php echo $id_rle_item_algorithm; ?>' type="hidden">
					</div>
					<div style="float:left;">
					</div>
				</div>			
		...
		<tr>
			...
			<td style="border:1px solid #5a1f08;padding:5px;">
				<input <?php echo $status_show_rle_algorithm; ?> id='visibility_ref_rle_algorithm_dialog_show_information_express_algorithm' type='checkbox' style='width:90%;' disabled>
			</td>
		</tr>
		<tr>
			<td style="border:1px solid #5a1f08;padding:5px;background:#f8baa1;width:300px;font-weight:bold;">
		...
		<tr>
			...
			<td style="border:1px solid #5a1f08;padding:5px;">
				<?php echo $date_last_modified_algorithm; ?>
			</td>
		</tr>
		<tr>
			<td style="border:1px solid #5a1f08;padding:5px;background:#f8baa1;width:300px;font-weight:bold;">
		...
		<tr>
			...
			<td style="border:1px solid #5a1f08;">
				<div id='comment_algorithm_dialog_show_information_express_algorithm' style='width:90%;height:200px;' ><?php echo $comment_algorithm; ?></div>
			</td>
		</tr>
		<tr>
			<td style="border:1px solid #5a1f08;padding:5px;background:#f8baa1;width:300px;font-weight:bold;">
			...
			<td style="border:1px solid #5a1f08;">
				<div id="text_algorithm_dialog_show_information_express_algorithm" style="width:90%;height:300px;overflow:auto;"><?php echo $text_algorithm_algorithm; ?></div>
			</td>
		</tr>
		<tr>
			<td style="border:1px solid #5a1f08;padding:5px;background:#f8baa1;width:300px;font-weight:bold;">
			...
			<td style="border:1px solid #5a1f08;padding:5px;">
				<input <?php echo $status_use_web_page_algorithm_algorithm; ?> id='use_ref_html_algorithm_dialog_show_information_express_algorithm' type='checkbox' style='width:90%;' disabled>
			</td>
		</tr>
		<tr>
			<td style="border:1px solid #5a1f08;padding:5px;background:#f8baa1;width:300px;font-weight:bold;">
			...
			<td style="border:1px solid #5a1f08;padding:5px;">
				<input <?php echo $status_algorithm; ?> id='visibility_dialog_show_information_express_algorithm' type='checkbox' style='width:90%;' disabled>
			</td>
		</tr>
		<tr>
			<td colspan=2 style='font-size:1em;text-align:center; padding-top:20px;'>
				...
				<button onclick='fn_add_new_algorithm();' class='btn' id='btn_add_new_algorithm_dialog_show_information_express_algorithm'>Добавить алгоритм</button>-->
			</td>
		</tr>
	</table>
	<input type='hidden' id='id_algorithm_dialog_show_information_express_algorithm' value="<?php echo $id_algorithm; ?>"/>
