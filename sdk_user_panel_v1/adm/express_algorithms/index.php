<?php
	...
	$title_adm= "Управление алгоритмами экспресс-анализа";
			...
			<table cellpadding=0 cellspacing=0 style="width:100%;">
				<tr>
					<td style="font-size:0.6em;padding-left:10px;padding-bottom:5px;border-bottom: 1px solid #5a1f08; width: 100%; height:50px; vertical-align:bottom;">
						<button class='btn_add' onclick="fn_show_dialog_add_new_express_algoruthm();">Добавить новый алгоритм</button>
						...
						<button class='btn_show_sign' onclick="$('#sign_for_algorithm_dialog').dialog('open');fn_get_sign_algorithms();" title="Условные обозначения для алгоритмов экспресс-анализа">sign</button>
					</td>
				</tr>
				<tr>
					<td id="td_express_algorithms" style="text-align:center;padding:10px;">
...
<div id="add_new_type_board_dialog" style="border:1px solid #5a1f08;display:none;">
	<table style="width:100%;">
		...
		<tr>
			...
			<td style="border:1px solid #5a1f08;padding:5px;text-align:center;">
				<div style="height:25px;">
					<div onclick="fn_pdf_algorithm_preview($('#path_pdf_algorithm_add_new_type_board_dialog').val());" id="ref_pdf_algorithm_preview_add_new_type_board_dialog" style="width:25px; height:100%;padding:0px;margin:0px;float:left;display:inline;background:#f0efee url('../../styles/images/preview_icon.png') center no-repeat;border:1px solid black;border-right:none;cursor:pointer;">
					</div>
					<div style="padding:0px;margin:0px;float:left;height:100%;">
						<input id="path_pdf_algorithm_add_new_type_board_dialog" type="textbox" style="width: 400px;height:100%;padding:0px;background: #f0efee;border:none;border:1px solid black;padding:0px;margin:0px;" disabled>
					</div>
					<div style="float:left;height:100%;padding:0px">
						<button onclick='fn_btn_choice_file_pdf_algorithm_add_new_type_board_dialog();' class="btn" id="btn_choice_pdf_algorithm_path_pdf_algorithm_add_new_type_board_dialog" style="height:100%;padding:0px;vertical-align:middle;margin:0px;font-size:0.6em;">Выбрать</button>
					</div>
		...
		<tr>
			...
			<td style="border:1px solid #5a1f08;padding:5px;text-align:center;">
				<input id="visibility_file_pdf_algorithm_add_new_type_board_dialog" type="checkbox" style="">
			</td>
		</tr>
		<tr>
...
<div id="add_new_express_algorithm_dialog" style='display:none;'>
	<table style='width:100%;'>
		<tr>
			<td colspan=2>
		...
		<tr>
			...
			<td style="border:1px solid #5a1f08;padding:5px;text-align:center;">
				<div style="height:25px;">
					...
					<div style="padding:0px;margin:0px;float:left;height:100%;">
						<input id="path_rle_algorithm_dialog_add_new_express_algorithm" type="textbox" style="width: 400px;height:100%;padding:0px;background: #f0efee;border:none;border:1px solid black;padding:0px;margin:0px;" disabled>
						<input id="path_id_rle_algorithm_dialog_add_new_express_algorithm" value='' type="hidden">
					</div>
					<div style="float:left;height:100%;padding:0px">
						<button onclick="fn_get_choice_rle_for_algorithm('',$('#hdn_id_type_board_tbl_algorithms').val());" class="btn" id="btn_choice_rle_algorithm_dialog_add_new_express_algorithm" style="height:100%;padding:0px;vertical-align:middle;margin:0px;font-size:0.6em;">Выбрать</button>
					</div>
					<div style="float:left;">
					</div>
				</div>			
...
<div id="add_new_rle_item_dialog" style='display:none;'>
	<table style='width:100%;'>
		...
		<tr style='display:none;'>
			...
			<td style="border:1px solid #5a1f08;padding:5px;text-align:center;">
				<div style="height:25px;">
					<div onclick='fn_ref_algorithm_rle_item_preview();' id="ref_algorithm_rle_item_preview_dialog_add_new_rle_item" style="width:25px; height:100%;padding:0px;margin:0px;float:left;display:inline;background:#f0efee url('../../styles/images/preview_icon.png') center no-repeat;border:1px solid black;border-right:none;cursor:pointer;">
					</div>
					<div style="padding:0px;margin:0px;float:left;height:100%;">
						<input value='' id="path_algorithm_rle_item_dialog_add_new_rle_item" type="textbox" style="width: 400px;height:100%;padding:0px;background: #f0efee;border:none;border:1px solid black;padding:0px;margin:0px;" disabled>
						<input value='' id="path_id_algorithm_rle_item_dialog_add_new_rle_item" type="textbox" style="width: 400px;height:100%;padding:0px;background: #f0efee;border:none;border:1px solid black;padding:0px;margin:0px;" disabled>
					</div>
					<div style="float:left;height:100%;padding:0px">
						<button onclick='fn_btn_choice_algorithm_rle_item_dialog_add_new_rle_item();' class="btn" id="btn_choice_algorithm_rle_item_dialog_add_new_rle_item" style="height:100%;padding:0px;vertical-align:middle;margin:0px;font-size:0.6em;">Выбрать</button>
					</div>
					<div style="float:left;">
					</div>
				</div>			
...
<div id="add_new_sign_algorithms_dialog" style='display:none;'>
	<table style='width:100%;'>
		<tr>
			<td colspan=2>
				<p id="error_add_new_sign_algorithms_dialog" style="color:red;"></p>
			</td>
		</tr>
		<tr style='display:none;'>
			<td style="border:1px solid #5a1f08;padding:5px;background:#f8baa1;width:250px;font-weight:bold;">
			...
			<td style="border:1px solid #5a1f08;padding:5px;">
				<input id='id_type_board_add_new_sign_algorithms_dialog' type='textbox' style='width:90%;' >
			</td>
		</tr>
		<tr>
			<td style="border:1px solid #5a1f08;padding:5px;background:#f8baa1;width:300px;font-weight:bold;">
			...
			<td style="border:1px solid #5a1f08;padding:5px;">
				<input id='name_add_new_sign_algorithms_dialog' type='textbox' style='width:90%;' >
			</td>
		</tr>
		<tr>
			<td style="border:1px solid #5a1f08;padding:5px;background:#f8baa1;width:300px;font-weight:bold;">
			...
			<td style="border:1px solid #5a1f08;">
				<textarea id='description_add_new_sign_algorithms_dialog' style='width:90%;height:200px;' ></textarea>
			</td>
		</tr>
		<tr>
			<td style="border:1px solid #5a1f08;padding:5px;background:#f8baa1;width:300px;font-weight:bold;">
			...
			<td style="border:1px solid #5a1f08;padding:5px;text-align:center;">
				<div style="height:25px;">
					<div onclick="fn_file_preview($('#path_html_add_new_sign_algorithms_dialog').val());" id="ref_html_preview_add_new_sign_algorithms_dialog" style="width:25px; height:100%;padding:0px;margin:0px;float:left;display:inline;background:#f0efee url('../../styles/images/preview_icon.png') center no-repeat;border:1px solid black;border-right:none;cursor:pointer;">
					</div>
					<div style="padding:0px;margin:0px;float:left;height:100%;">
						<input id="path_html_add_new_sign_algorithms_dialog" type="textbox" style="width: 400px;height:100%;padding:0px;background: #f0efee;border:none;border:1px solid black;padding:0px;margin:0px;" disabled>
					</div>
					<div style="float:left;height:100%;padding:0px">
						<button onclick='fn_btn_choice_file_html_add_new_sign_algorithms_dialog();' class="btn" id="btn_choice_html_add_new_sign_algorithms_dialog" style="height:100%;padding:0px;vertical-align:middle;margin:0px;font-size:0.6em;">Выбрать</button>
					</div>
					<div style="float:left;">
					</div>
				</div>			
		...
		<tr>
			...
			<td style="border:1px solid #5a1f08;padding:5px;text-align:center;">
				<div style="height:25px;">
					<div onclick="fn_file_preview($('#path_pdf_add_new_sign_algorithms_dialog').val());" id="ref_pdf_pdf_preview_add_new_sign_algorithms_dialog" style="width:25px; height:100%;padding:0px;margin:0px;float:left;display:inline;background:#f0efee url('../../styles/images/preview_icon.png') center no-repeat;border:1px solid black;border-right:none;cursor:pointer;">
					</div>
					<div style="padding:0px;margin:0px;float:left;height:100%;">
						<input id="path_pdf_add_new_sign_algorithms_dialog" type="textbox" style="width: 400px;height:100%;padding:0px;background: #f0efee;border:none;border:1px solid black;padding:0px;margin:0px;" disabled>
					</div>
					<div style="float:left;height:100%;padding:0px">
						<button onclick='fn_btn_choice_file_pdf_add_new_sign_algorithms_dialog();' class="btn" id="btn_choice_pdf_add_new_sign_algorithms_dialog" style="height:100%;padding:0px;vertical-align:middle;margin:0px;font-size:0.6em;">Выбрать</button>
					</div>
					<div style="float:left;">
					</div>
				</div>			
		...
		<tr>
			...
			<td style="border:1px solid #5a1f08;padding:5px;">
				<input id='visibility_ref_pdf_add_new_sign_algorithms_dialog' type='checkbox' style='width:90%;' >
			</td>
		</tr>
		<tr>
			<td style="border:1px solid #5a1f08;padding:5px;background:#f8baa1;width:300px;font-weight:bold;">
			...
			<td style="border:1px solid #5a1f08;">
				<textarea id='comment_add_new_sign_algorithms_dialog' style='width:90%;height:200px;' ></textarea>
			</td>
		</tr>
		<tr>
			<td style="border:1px solid #5a1f08;padding:5px;background:#f8baa1;width:300px;font-weight:bold;">
			...
			<td style="border:1px solid #5a1f08;">
				<textarea id="text_add_new_sign_algorithms_dialog" style="width:90%;height:300px;overflow:auto;"></textarea>
			</td>
		</tr>
		<tr>
			<td style="border:1px solid #5a1f08;padding:5px;background:#f8baa1;width:300px;font-weight:bold;">
			...
			<td style="border:1px solid #5a1f08;padding:5px;">
				<input id='use_ref_html_add_new_sign_algorithms_dialog' type='checkbox' style='width:90%;' >
			</td>
		</tr>
		<tr>
			<td style="border:1px solid #5a1f08;padding:5px;background:#f8baa1;width:300px;font-weight:bold;">
			...
			<td style="border:1px solid #5a1f08;padding:5px;">
				<input id='visibility_add_new_sign_algorithms_dialog' type='checkbox' style='width:90%;' >
			</td>
		</tr>
		<tr>
			<td colspan=2 style='font-size:1em;text-align:center; padding-top:20px;'>
				<button class='btn' onclick="fn_sign_algorithms_preview();">Предварительный просмотр</button>
				<button onclick="fn_add_new_sign_algorithms();" class='btn' id='btn_add_new_sign_algorithms_dialog'>Добавить модуль</button>
			</td>
		</tr>
	</table>
</div>
...
<div id="edit_sign_algorithms_dialog" style='display:none;'>

</div>

<div id="dialog_show_information_sign_algorithms" style='display:none;'>
	<div id="show_information_sign_algorithms">
	
	</div>
	<button onclick="$('#dialog_show_information_sign_algorithms').dialog('close');fn_edit_sign_algorithms($('#id_sign_algorithm_dialog_show_full_information_sign_algorithm').val());" class='btn_edit' id='btn_edit_dialog_show_information_sign_algorithm' style='font-size:0.6em;'>Редактировать модуль условных обозначений</button>
</div>



<div id="algorithm_preview_dialog" style="display:none;">
...
<div id="dialog_choice_rle" style='display:none;'>
	<div id="dialog_choice_rle_inner">
		
	</div>
	<div style='width:100%;text-align:center;padding-top:10px;'><button id="btn_choice_dialog_choice_rle" onclick="fn_btn_choice_dialog_choice_rle()";>Выбрать</button></div>
</div>
<div id="sign_for_algorithm_dialog" style='display:none;'>
</div>		
