<?php
	...
	$key_type_board_rle_item = mysql_real_escape_string($rle_item['key_type_board_rle_item']);
	...
	$query = "select $tbl_type_boards.id from $tbl_type_boards where key_type_board = '$key_type_board_rle_item'";
	...
	if(!$res)
	{
		exit("Ощибка при идетификации типа борта");
	}
	...
	if($status_show_rle_rle_item  == "0")
	{
		$status_show_rle_rle_item  = "";
	}
	else
	{
...
?>
	<table style='width:100%;'>
		<tr>
			<td colspan=2>
				<p id="error_edit_rle_item_dialog_edit_rle_item" style="color:red;"></p>
			</td>
		</tr>
		<tr>
			...
			<td style="border:1px solid #5a1f08;padding:5px;">
				<input value="<?php echo $id_type_board; ?>" id="id_type_board_dialog_edit_rle_item" type='textbox' style='width:90%;'>
			</td>
		</tr>
		<tr>
			...
			<td style="border:1px solid #5a1f08;padding:5px;">
				<input value="<?php echo $key_rle_item_rle_item; ?>" id="key_rle_item_dialog_edit_rle_item" type='textbox' style='width:90%;'>
			</td>
		</tr>
		<tr>
			<td style="border:1px solid #5a1f08;padding:5px;background:#f8baa1;width:300px;font-weight:bold;">
			...
			<td style="border:1px solid #5a1f08;padding:5px;">
				<input value="<?php echo $name_rle_item_rle_item; ?>" id="name_rle_item_dialog_edit_rle_item" type='textbox' style='width:90%;'>
			</td>
		</tr>
		<tr>
			<td style="border:1px solid #5a1f08;padding:5px;background:#f8baa1;width:300px;font-weight:bold;">
			...
			<td style="border:1px solid #5a1f08;padding:5px;text-align:center;">
				<div style="height:25px;">
					<div onclick="fn_html_rle_item_preview($('#path_html_rle_item_dialog_edit_rle_item').val());" id="ref_html_rle_item_preview_dialog_edit_rle_item" style="width:25px; height:100%;padding:0px;margin:0px;float:left;display:inline;background:#f0efee url('../../styles/images/preview_icon.png') center no-repeat;border:1px solid black;border-right:none;cursor:pointer;">
					</div>
					<div style="padding:0px;margin:0px;float:left;height:100%;">
						<input value='<?php echo $ref_web_page_text_rle_item_rle_item;?>' id="path_html_rle_item_dialog_edit_rle_item" type="textbox" style="width: 400px;height:100%;padding:0px;background: #f0efee;border:none;border:1px solid black;padding:0px;margin:0px;" disabled>
					</div>
					<div style="float:left;height:100%;padding:0px">
						<button onclick="fn_btn_choice_file_html_rle_item_dialog_edit_rle_item();" class="btn" id="btn_choice_html_rle_item_dialog_edit_rle_item" style="height:100%;padding:0px;vertical-align:middle;margin:0px;font-size:0.6em;">Выбрать</button>
					</div>
		...
		<tr>
			...
			<td style="border:1px solid #5a1f08;padding:5px;text-align:center;">
				<div style="height:25px;">
					<div onclick="fn_pdf_rle_item_preview($('#path_pdf_rle_item_dialog_edit_rle_item').val());" id="ref_pdf_rle_item_preview_dialog_edit_rle_item" style="width:25px; height:100%;padding:0px;margin:0px;float:left;display:inline;background:#f0efee url('../../styles/images/preview_icon.png') center no-repeat;border:1px solid black;border-right:none;cursor:pointer;">
					</div>
					<div style="padding:0px;margin:0px;float:left;height:100%;">
						<input value='<?php echo $ref_pdf_rle_item_rle_item;?>' id="path_pdf_rle_item_dialog_edit_rle_item" type="textbox" style="width: 400px;height:100%;padding:0px;background: #f0efee;border:none;border:1px solid black;padding:0px;margin:0px;" disabled>
					</div>
					<div style="float:left;height:100%;padding:0px">
						<button onclick='fn_btn_choice_file_pdf_rle_item_dialog_edit_rle_item();' class="btn" id="btn_choice_pdf_rle_item_dialog_edit_rle_item" style="height:100%;padding:0px;vertical-align:middle;margin:0px;font-size:0.6em;">Выбрать</button>
					</div>
					<div style="float:left;">
					</div>
				</div>		
		...
		<tr>
			...
			<td style="border:1px solid #5a1f08;padding:5px;">
				<input <?php echo $status_show_pdf_rle_item; ?> id='visibility_ref_pdf_rle_item_dialog_edit_rle_item' type='checkbox' style='width:90%;'>
			</td>
		</tr>
		<tr <?php echo $dispaly_none_choice_algorithm; ?> >
			...
			<td style="border:1px solid #5a1f08;padding:5px;text-align:center;">
				<div style="height:25px;">
					<div onclick="fn_ref_algorithm_rle_item_preview($('#path_id_algorithm_rle_item_dialog_edit_rle_item').val());" id="ref_algorithm_rle_item_preview_dialog_edit_rle_item" style="width:25px; height:100%;padding:0px;margin:0px;float:left;display:inline;background:#f0efee url('../../styles/images/preview_icon.png') center no-repeat;border:1px solid black;border-right:none;cursor:pointer;">
					</div>
					<div style="padding:0px;margin:0px;float:left;height:100%;">
						<input value='<?php echo $key_algorithm_rle_item;?>' id="path_algorithm_rle_item_dialog_edit_rle_item" type="textbox" style="width: 400px;height:100%;padding:0px;background: #f0efee;border:none;border:1px solid black;padding:0px;margin:0px;" disabled>
						<input id="path_id_algorithm_rle_item_dialog_edit_rle_item" value='<?php echo $id_algorithm_rle_item ?>' type=hidden>
					</div>
					<div style="float:left;height:100%;padding:0px">
						<button onclick="fn_get_choice_algorithm_for_rle_item(<?php echo $id_rle_item;?>,$('#hdn_id_type_board_tbl_rle_items').val());" class="btn" id="btn_choice_algorithm_rle_item_dialog_edit_rle_item" style="height:100%;padding:0px;vertical-align:middle;margin:0px;font-size:0.6em;">Выбрать</button>
					</div>
					<div style="float:left;">
					</div>
				</div>			
		...
		<tr>
			...
			<td style="border:1px solid #5a1f08;padding:5px;">
				<input <?php echo $status_show_algorithm_rle_item; ?> id='visibility_ref_algorithm_rle_item_dialog_edit_rle_item' type='checkbox' style='width:90%;'>
			</td>
		</tr>
		<tr>
			<td style="border:1px solid #5a1f08;padding:5px;background:#f8baa1;width:300px;font-weight:bold;">
			...
			<td style="border:1px solid #5a1f08;">
				<textarea id='comment_rle_item_dialog_show_information_rle_item' style='width:90%;height:200px;' ><?php echo $comment_rle_item; ?></textarea>
			</td>
		</tr>
		<tr>
			<td style="border:1px solid #5a1f08;padding:5px;background:#f8baa1;width:300px;font-weight:bold;">
			...
			<td style="border:1px solid #5a1f08;">
				<textarea id="text_rle_item_dialog_edit_rle_item" style="width:90%;height:300px;overflow:auto;"><?php echo $text_rle_item_rle_item; ?></textarea>
			</td>
		</tr>
		<tr>
			<td style="border:1px solid #5a1f08;padding:5px;background:#f8baa1;width:300px;font-weight:bold;">
			...
			<td style="border:1px solid #5a1f08;padding:5px;">
				<input <?php echo $status_use_web_page_rle_item_rle_item; ?> id='use_ref_html_rle_item_dialog_edit_rle_item' type='checkbox' style='width:90%;'>
			</td>
		</tr>
		<tr>
			<td style="border:1px solid #5a1f08;padding:5px;background:#f8baa1;width:300px;font-weight:bold;">
			...
			<td style="border:1px solid #5a1f08;padding:5px;">
				<input <?php echo $status_rle_item; ?> id='visibility_dialog_edit_rle_item' type='checkbox' style='width:90%;'>
			</td>
		</tr>
		<tr>
			<td colspan=2 style='font-size:1em;text-align:center; padding-top:20px;'>
				<button class='btn' onclick="fn_edit_rle_item_preview();">Предварительный просмотр</button>
				<button onclick='fn_save_edit_rle_item();' class='btn' id='btn_add_new_rle_item_dialog_show_information_rle_item'>Сохранить пункт РЛЭ</button>
			</td>
		</tr>
	</table>
	<input type='hidden' id='id_rle_item_dialog_edit_rle_item' value="<?php echo $id_rle_item; ?>"/>
	<script type="text/javascript">
		$(function(){
			$(".btn").button();
			fn_tinymce_for_edit_rle_item();
		});
	</script>