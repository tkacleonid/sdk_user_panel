<?php
	...
	$query = "select position,id from $tbl_rle_items where position < $cur_pos AND key_type_board='$key_type_board' order by position DESC";
	...
	$query = "update $tbl_rle_items set position=$pos_prev where id=$id AND  key_type_board='$key_type_board';";
	...
	$query = "update $tbl_rle_items set position=$cur_pos where id=$id_prev AND key_type_board='$key_type_board';";
