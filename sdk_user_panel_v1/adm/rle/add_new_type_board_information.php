<?php
	...
	$query = "insert into $tbl_type_boards(name,short_description,long_description,status,key_type_board,date_add,date_last_modified,id_admin_add,id_admin_modified,position)
		values(
				'$name_type_board',
