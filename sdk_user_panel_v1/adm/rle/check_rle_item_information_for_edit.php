<?php
	...
	$query = "select count(*) from $tbl_rle_items where key_rle_item='$key_rle_item' and id<>$id_rle_item";
	...
	$query = "select count(*) from $tbl_rle_items where name_rle_item='$name_rle_item' and id<>$id_rle_item";
