<?php
	...
	$query = "select position,id from $tbl_blocks_menu_ru where position > $cur_pos order by position ASC";
	...
	$query = "update $tbl_blocks_menu_ru set position=$pos_next where id=$id;";
	...
	$query = "update $tbl_blocks_menu_ru set position=$cur_pos where id=$id_next;";
