<?php
	...
	$query= "select count(*) from $tbl_operator_manual_items_ru where key_operator_manual_item='$key_operator_manual_item'";
	...
	$query= "select count(*) from $tbl_operator_manual_items_ru where name='$name_operator_manual_item'";
	...
	if($res > 0)
	{
		$str_error .= "Пункт руководства пользователя с указанным именем уже существует<br>";
	}
