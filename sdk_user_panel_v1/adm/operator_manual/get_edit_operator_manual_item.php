<?php
	...
	if($id_operator_manual_item== -1)
	{
		exit("Произошла ошибка при определении пункта руководства пользователя");
	}
...
?>
	...
	<table style='width:100%;'>
		<tr>
			<td colspan=2>
				<p id="error_dialog_edit_operator_manual_item" style="color:red;"></p>
			</td>
		</tr>
		<tr>
			<td colspan=2>
		...
		<tr>
			...
			<td style="border:1px solid #5a1f08;padding:5px;">
				<input value='<?php echo $key_operator_manual_item; ?>' id='key_operator_manual_item_dialog_edit_operator_manual_item' type='textbox' style='width:90%;' >
			</td>
		</tr>
		<tr>
			<td style="border:1px solid #5a1f08;padding:5px;background:#f8baa1;width:300px;font-weight:bold;">
			...
			<td style="border:1px solid #5a1f08;padding:5px;">
				<input value='<?php echo $name_operator_manual_item; ?>' id='name_operator_manual_item_dialog_edit_operator_manual_item' type='textbox' style='width:90%;' >
			</td>
		</tr>
		<tr>
			<td style="border:1px solid #5a1f08;padding:5px;background:#f8baa1;width:300px;font-weight:bold;">
			...
			<td style="border:1px solid #5a1f08;padding:5px;text-align:center;">
				<div style="height:25px;">
					<div onclick="fn_html_operator_manual_item_preview($('#path_html_operator_manual_item_dialog_edit_operator_manual_item').val());" id="ref_html_operator_manual_item_preview_dialog_edit_operator_manual_item" style="width:25px; height:100%;padding:0px;margin:0px;float:left;display:inline;background:#f0efee url('../../styles/images/preview_icon.png') center no-repeat;border:1px solid black;border-right:none;cursor:pointer;">
					</div>
					<div style="padding:0px;margin:0px;float:left;height:100%;">
						<input value='<?php echo $rref_html_text_operator_manual_item; ?>' id="path_html_operator_manual_item_dialog_edit_operator_manual_item" type="textbox" style="width: 400px;height:100%;padding:0px;background: #f0efee;border:none;border:1px solid black;padding:0px;margin:0px;" disabled>
					</div>
					<div style="float:left;height:100%;padding:0px">
						<button onclick='fn_btn_choice_file_html_operator_manual_item_dialog_edit_operator_manual_item();' class="btn" id="btn_choice_html_operator_manual_item_dialog_edit_operator_manual_item" style="height:100%;padding:0px;vertical-align:middle;margin:0px;font-size:0.6em;">Выбрать</button>
					</div>
		...
		<tr>
			...
			<td style="border:1px solid #5a1f08;">
				<textarea id='comment_operator_manual_item_dialog_edit_operator_manual_item' style='width:90%;height:200px;' ><?php echo $comment_operator_manual_item; ?></textarea>
			</td>
		</tr>
		<tr>
			<td style="border:1px solid #5a1f08;padding:5px;background:#f8baa1;width:300px;font-weight:bold;">
			...
			<td style="border:1px solid #5a1f08;">
				<textarea id="text_operator_manual_item_dialog_edit_operator_manual_item" style="width:90%;height:300px;overflow:auto;"><?php echo $text_operator_manual_item; ?></textarea>
			</td>
		</tr>
		<tr>
			<td style="border:1px solid #5a1f08;padding:5px;background:#f8baa1;width:300px;font-weight:bold;">
			...
			<td style="border:1px solid #5a1f08;padding:5px;">
				<input <?php echo $use_html_text_operator_manual_item; ?> id='use_ref_html_operator_manual_item_dialog_edit_operator_manual_item' type='checkbox' style='width:90%;' >
			</td>
		</tr>
		<tr>
			<td style="border:1px solid #5a1f08;padding:5px;background:#f8baa1;width:300px;font-weight:bold;">
			...
			<td style="border:1px solid #5a1f08;padding:5px;">
				<input <?php echo $status_operator_manual_item; ?> id='visibility_dialog_edit_operator_manual_item' type='checkbox' style='width:90%;' >
			</td>
		</tr>
		<tr>
			<td colspan=2 style='font-size:1em;text-align:center; padding-top:20px;'>
				<button class='btn' onclick="fn_edit_operator_manual_item_preview(<?php echo $id_operator_manual_item; ?>);">Предварительный просмотр</button>
				<button onclick='fn_save_edit_operator_manual_item(<?php echo $id_operator_manual_item; ?>);' class='btn' id='btn_edit_operator_manual_item_dialog_edit_operator_manual_item'>Сохранить пункт</button>
			</td>
		</tr>
	</table>


	<input type='hidden' id='id_operator_manual_item_dialog_edit_operator_manual_item' value="<?php echo $id_operator_manual_item; ?>"/>
	<script type="text/javascript">
		$(function(){
			$(".btn").button();
			fn_tinymce_for_edit_operator_manual_item();
		});
	</script>